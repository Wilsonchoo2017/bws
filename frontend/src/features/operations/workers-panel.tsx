    ...
    <div className='flex flex-col gap-6'>
      ...
      <div className='grid grid-cols-5 gap-3'>
        ...
        <StatCard
          ...
          onClick={() => {
            setFilter(filter === 'queued' ? 'all' : 'queued');
            setPage(1);
          }}
          color='yellow'
        />
        <StatCard
          ...
          onClick={() => {
            setFilter(filter === 'running' ? 'all' : 'running');
            setPage(1);
          }}
          color='blue'
        />
        ...
        <StatCard
          ...
          onClick={() => {
            setFilter(filter === 'failed' ? 'all' : 'failed');
            setPage(1);
          }}
          color='red'
        />
...
function ActiveWorkers({ jobs }: { readonly jobs: readonly WorkerJob[] }) {
  ...
  for (const job of jobs) {
    if (job.status === 'queued') {
      queuedByScraper[job.scraper_id] =
        (queuedByScraper[job.scraper_id] ?? 0) + 1;
    }
  }
